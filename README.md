...
* [Курс по основам языка програмирования Python от Яндекса](https://academy.yandex.ru/handbook/python) бесплатно     
 ...
 ['Ссылка на контрольную работу'] () Задание выложенов формате word -- поэтому тут файл не откроется, нажмите Download или View raw для скачивания на странице с файлом
